...
namespace I18N {
    ...
    static std::unordered_map<std::string, std::unordered_map<Language, std::string>> translations = {
        ...
        {"player_auto_self_revive", {{Language::English, "Auto Self Revive"}, {Language::Chinese, "自动自救"}}},
        {"player_self_revive", {{Language::English, "Self Revive"}, {Language::Chinese, "自救"}}},
        {"player_full_hp_revive", {{Language::English, "Full HP on Revive"}, {Language::Chinese, "复活满血"}}},
        ...
        {"aimbot_priority_health", {{Language::English, "Health"}, {Language::Chinese, "生命值"}}},
        {"aimbot_priority_distance", {{Language::English, "Distance"}, {Language::Chinese, "距离"}}},
        {"aimbot_priority_fov", {{Language::English, "FOV"}, {Language::Chinese, "视野"}}},
        {"player_full_bright", {{Language::English, "Full Bright"}, {Language::Chinese, "全亮"}}},
        {"player_full_bright_range", {{Language::English, "Range"}, {Language::Chinese, "范围"}}},
        {"player_full_bright_intensity", {{Language::English, "Intensity"}, {Language::Chinese, "强度"}}},
        {"player_full_bright_angle", {{Language::English, "Angle"}, {Language::Chinese, "角度"}}},
        {"player_full_bright_color", {{Language::English, "Color"}, {Language::Chinese, "颜色"}}},
        {"player_damage_multipliers", {{Language::English, "Damage Multipliers"}, {Language::Chinese, "伤害倍率"}}},
        {"player_damage_enemy", {{Language::English, "Enemy Damage"}, {Language::Chinese, "对敌伤害"}}},
        {"player_damage_received_self", {{Language::English, "Received (Self)"}, {Language::Chinese, "受到伤害(自身)"}}},
        {"player_damage_received_team", {{Language::English, "Received (Team/Bot)"}, {Language::Chinese, "受到伤害(队友/机器人)"}}},
        {"player_force_weakspot", {{Language::English, "Force Weakspot"}, {Language::Chinese, "强制弱点"}}},
        {"player_turret_damage", {{Language::English, "Turret Damage"}, {Language::Chinese, "炮台伤害"}}},
        {"player_turret_local_only", {{Language::English, "My Turrets Only"}, {Language::Chinese, "仅自己的炮台"}}},
