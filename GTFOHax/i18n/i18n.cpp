...
namespace I18N {
    ...
    static std::unordered_map<std::string, std::unordered_map<Language, std::string>> translations = {
        ...
        {"player_instant_scan", {{Language::English, "Instant Scan"} ZH("瞬间扫描")}},
        {"player_solo_scan", {{Language::English, "Solo Scan"} ZH("单人扫描")}},
        {"player_auto_scan", {{Language::English, "Auto Scan"} ZH("自动扫描")}},
        ...
        {"player_speed_modifier", {{Language::English, "Speed Modifier"} ZH("速度修改")}},
        {"player_speed_multiplier", {{Language::English, "Speed Multiplier"} ZH("速度倍率")}},
